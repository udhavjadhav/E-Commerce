                ...
                loading
                    ...
                    <div className='d-flex align-items-center'>
                        <div className="card m-2 text-center">
                            <img style={{ height: '25vh', width: '25vh', margin: '3vh', marginLeft: '12vh' }} className="card-img-top" src={prod.image} alt="Card image cap" />
                            <div className="card-body">
                                <p className='text-center'>{prod.title}</p>
                                <h6 className="card-title text-center">Price: {prod.price} $</h6>
